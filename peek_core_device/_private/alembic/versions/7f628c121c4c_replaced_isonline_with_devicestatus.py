...
# ### commands auto generated by Alembic - please adjust! ###
    ...
    sa.Column('lastOnline', sa.DateTime(timezone=True), nullable=True),
    sa.Column('lastUpdateCheck', sa.DateTime(timezone=True), nullable=True),
    ...
    sa.Column('buildDate', sa.DateTime(timezone=True), nullable=False),
    sa.Column('appVersion', sa.String(length=15), nullable=False),
    ...
    op.create_table('GpsLocation',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('deviceToken', sa.String(length=50), nullable=False),
    sa.Column('latitude', sa.Float(), nullable=False),
    sa.Column('longitude', sa.Float(), nullable=False),
    sa.Column('updatedDate', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['deviceToken'], ['core_device.DeviceInfo.deviceToken'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('deviceToken'),
    schema='core_device'
    )
    op.create_table('GpsLocationHistory',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('deviceToken', sa.String(length=50), nullable=False),
    sa.Column('latitude', sa.Float(), nullable=False),
    sa.Column('longitude', sa.Float(), nullable=False),
